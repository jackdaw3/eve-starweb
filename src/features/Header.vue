<template>
  <div class="header">
    <el-menu class="menu" mode="horizontal" :ellipsis="false">
      ...
      <el-menu-item index="2" style="margin-right: -25px;" v-if="regionVisible">
        <el-dropdown @command="regionChange">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-input v-model="searchQuery" :placeholder="t('header.search')" clearable :prefix-icon="Search"
                style="max-width: 100%;padding: 0 5px;" size="small" />
              <el-scrollbar height="200px" style="margin-top: 3px;">
                <el-dropdown-item v-for="region in filteredRegionData" :command="region">
                  {{ region.RegionName }}
                </el-dropdown-item>
              </el-scrollbar>
            </el-dropdown-menu>
      ...
      <el-menu-item index="3" style="margin-right: -15px;">
...
import { ref, watch, computed, onBeforeMount, reactive, onMounted } from 'vue'
